...
<style>
    ...
    .vi-tabs-wrap::-webkit-scrollbar { display: none; }
    ...
    .vi-tab:hover { color: #6b7280; background: #fdf2f8; }
    .vi-tab.active-all    { background: #fce7f3; color: #be185d; }
    .vi-tab.active-pend   { background: #fce7f3; color: #be185d; }
    .vi-tab.active-atras  { background: #fee2e2; color: #dc2626; }
    .vi-tab.active-pago   { background: #d1fae5; color: #059669; }
    ...
    .vi-search-input::placeholder { color: #d1b0c1; }
    ...
    .vi-search-clear:hover { color: #be185d; }
    ...
    .vi-search-btn:hover { transform: translateY(-1px); box-shadow: 0 5px 16px #ec489940; }
    ...
    @media (min-width: 768px) { .vi-cards { display: none; } }
    ...
    @media (min-width: 768px) { .vi-table-wrap { display: block; } }
    ...
    .vi-table thead th:last-child { text-align: right; }
    ...
    .vi-table tbody tr:hover { background: #fffbfd; }
    ...
    .vi-table tbody tr:hover .vi-td-name { color: #be185d; }
    .vi-td-sub {
        font-size: 0.75rem;
        color: #c9a0b8;
        margin-top: 0.1rem;
    ...
    .badge-pendente .vi-badge-dot { background: #ec4899; }
    .badge-atrasado  { background: #fee2e2; color: #dc2626; }
    .badge-atrasado .vi-badge-dot { background: #dc2626; }
    .badge-pago      { background: #d1fae5; color: #059669; }
    .badge-pago .vi-badge-dot { background: #059669; }
    .badge-flexivel  { background: #ede9fe; color: #7c3aed; }
    .badge-flexivel .vi-badge-dot { background: #7c3aed; animation: pulse 2s infinite; }
    ...
    .vi-action-btn.view:hover  { background: #fce7f3; color: #be185d; }
    .vi-action-btn.edit:hover  { background: #fef3c7; color: #d97706; }
    .vi-action-btn.del:hover   { background: #fee2e2; color: #dc2626; }
    ...
    .vi-table-wrap { animation: fadeUp 0.3s ease both; }
</style>
            ...
            <div class="vi-card-bottom">
                ...
                <div style="display:flex;gap:0.2rem;">
                    ...
                    <a href="{{ route('vendas.edit', $venda->id) }}" class="vi-action-btn edit" title="Editar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                    </a>
